    ...
    <div class="bg-white h-12 px-4 flex items-center">
        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="rounded-full pl-8 w-48 bg-gray-200 h-8 focus:outline-none focus:shadow-outline font-sm text-sm" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link :to="'/users/' + user.data.user_id" class="px-6 border-b-2 border-white h-full flex items-center">
                <img src="https://previews.123rf.com/images/yupiramos/yupiramos1607/yupiramos160710209/60039275-young-male-cartoon-profile-vector-illustration-graphic-design-.jpg" alt="profile user" class="w-8 h-8 object-cover rounded-full">
            </router-link>
