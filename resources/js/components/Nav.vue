<template>
    <div class="bg-white h-12 flex items-center px-4 border-b border-gray-400 shadow">
        <!-- ### LEFT Side ### -->
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" placeholder="Search Facebook" class="rounded-full pl-8 w-48 bg-gray-200 h-8 focus:outline-none focus:shadow-outline font-sm">
                </div>
            </div>
        </div>
